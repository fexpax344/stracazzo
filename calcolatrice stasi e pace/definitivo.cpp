    ...
    do {
        ...
        //inizio casi
			case 0 : //colori 
					 ...
					 }else{if (a==1){system("color 1f");
					 }else{if (a==2){system("color 2f");
					 }else{if (a==3){system("color 3f");
					 }else{if (a==4){system("color 4f");
					 }else{if (a==5){system("color 5f");
					 }else{if (a==6){system("color 6f");
					 }else{if (a==7){system("color 7f");
					 }else{if (a==8){system("color 8f");
